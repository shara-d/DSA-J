...
// ---------------------------------------------------------------------------- PROCTOR'S DATA --------------------------------------------------------------------
// proctor(string name, string proctor_id, string password, string message, string num)
...
void proctor :: set_proctor_id(string s)
{
    this -> proctor_id = s;
}

void proctor :: set_name(string s)
{
    name = s;
}

void proctor :: set_phone_num(string s)
{
    phone_num = s;
}
...
void proctor_message_error(string);
void student_data_modify(student *);
void student_reg_error();
void admin_after_modifying(student *);
void proctor_data_modify(proctor *);
void admin_proctor_after_modify(proctor *);
...
string admin_username = "DR.DILIP";
...
// -------------------------------------------- MODIFY PROCTOR INFORMATION --------------------------------

void modify_proctor_information()
{
    system("clear");
    cout << "Enter the proctor ID of the proctor whose data you want to change : " << endl;
    ...
    if(flag == 0)
    {
        proctor_message_error("modify");
    }
    else
    {

        proctor_data_modify(pr);
    }
...
void proctor_data_modify(proctor *pr)
{
    system("clear");
    cout << "What do you want to modify? " << endl << endl;
    cout << "1. Name. " << endl;
    cout << "2. Proctor ID. " << endl;
    cout << "3. Phone Numnber. " << endl;
    ...
    if(temp_arg == "1")
    {
        ...
        pr -> set_name(temp_name);

        cout << endl;
        cout << "The name has been successfully chaged to " << pr -> get_name() << endl;
        cout << endl << endl;

        admin_proctor_after_modify(pr);       
    }

    else if(temp_arg == "2")
    {
        system("clear");
        cout << "Enter the new proctor ID that you want to change to: " << endl;
        string temp_num;
        cin >> temp_num;

        pr -> set_proctor_id(temp_num);

        cout << endl;
        cout << "Then proctor ID has been successfully changed to " << pr -> get_proctor_id() << "." << endl;
        cout << endl << endl;
    ...
    else if(temp_arg == "3")
    {
        ...
        pr -> set_phone_num(temp_num);

        cout << endl;
        cout << "The phone number has been successfully changed to " << pr -> get_phone_num() << "." << endl;
        cout << endl << endl;
...
// --------------------------------------- ADMIN PROCTOR AFTER LOGIN ---------------------------

void admin_proctor_after_modify(proctor *pr)
{
...
void modify_student_information()
{
    ...
    student *ptr = hashing_students[hash_func(reg_num)].get_student_front_ptr();
...
// ---------------------------------------------- MODIFY PARTICULAR STUDENT ----------------------------------

void student_data_modify(student *ptr)
{
    system("clear");
    cout << "What do you want to modify? " << endl << endl;
    cout << "1. Name. " << endl;
...
void admin_after_modifying(student *ptr)
{
    cout << "What do you want to do next? " << endl << endl;
    cout << "1. Modify anything else. " << endl;
    cout << "2. Go back to your main menu." << endl;
...
void proctor_message_error(string s)
{
    system("clear");
...
void hashing_the_student_info()
{
    ...
    for(int i = 0; i < 3; i++)
    {
        ...
        while(ptr != NULL)
        {
            ...
            // don't mess with the "ptr" pointer  
...
{
    p -> set_students("Mateen", "19BCE0003", "8868888227", "ABC", "ABC123", "ABC123", "jay_s");
    p -> set_students("Sharadindu Adhikari ", "19BCE2105", "8235387342", "BCD", "BCD123", "BCD123", "delhi73");
    p -> set_students("Kapadia Dhvani Hemish", "19BCE2079", "6377288941", "DEF", "DEF123", "DEF123", "madrid34");
